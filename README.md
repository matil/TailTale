...
- **GPU:** Free HuggingFace ZeroGPU (NVIDIA H200)
- **Frontend:** React, single HTML file, no server needed
- **12 classic bedtime stories** included

Works on any phone or computer with a modern browser.
